...
class HTMLWriter  {
	 ...
	 *                         div->data = content of the div
	 *                         div->attr = array of attributes (div element)
	 *                                     Example div["att"]["width"] = "100%";
	 ...
	 *                         table->data = content of the table (matrix nm - row/col)
	 *                         table->attr = array of attributes (table element)
	 *                              Example table["att"]["width"] = "100%";
	 *                              Each sub element is identified by key:
	 *                                table["att"]["th"][index] = 'style="width: 100%;"';
	 *                                table["att"]["tr"][index] = 'style="width: 100%;"';
	 *                                table["att"]["td"][row][column] = 'id="value" style="width: 100%;"';
	 * @param  boolean $print print the element or not
	 * @return String         returns the string with the code of the element
	 */
